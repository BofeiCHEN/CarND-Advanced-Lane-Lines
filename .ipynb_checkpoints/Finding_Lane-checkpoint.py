...
def find_lane_pixels(binary_warped):
    ...
    for window in range(nwindows):
        ...
        win_xleft_low = leftx_current - margin  # Update this x_left 
        win_xleft_high = leftx_current + margin  # Update this x_right
        win_xright_low = rightx_current - margin  # Update this x_left
        win_xright_high = rightx_current + margin  # Update this x_right
        ...
        #    if((nonzeroy[i]<win_y_high)&(nonzeroy[i]>=win_y_low)):
